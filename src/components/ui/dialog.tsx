  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          // Ikkuna on keskitetty fixed-elementti ilman omaa korkeusrajaa, joten pitkä
        // sisältö valui ruudun ylä- ja alapuolelle. Radix lukitsee samalla taustan
        // vierityksen, joten puhelimella ruudun ulkopuolelle jäänyttä sisältöä ja
        // nappeja ei päässyt näkemään lainkaan. dvh ottaa huomioon myös
        // mobiiliselaimen osoitepalkin.
